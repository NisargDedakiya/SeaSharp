...
export const POST = withApiHandler(
  async (request: Request) => {
    ...
    // docs/01-product-vision.md), but only Exporter/Importer/Investor have a
    // live registration flow so far — same scope boundary as Phase 1, now
    // extended for the investor marketplace (docs/02-product-requirements.md
    // §5.4).
